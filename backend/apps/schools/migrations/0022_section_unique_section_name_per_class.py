...
def dedupe_sections(apps, schema_editor):
    """Remove duplicate (class_obj, name) Section rows before adding the
    unique constraint, keeping the lowest-id row in each group."""
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(dedupe_sections, migrations.RunPython.noop),
