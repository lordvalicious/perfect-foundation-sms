#!/usr/bin/env python
"""Seed script to populate ReportDefinition for remaining categories."""
...
def main():
    # Academic Operations
    cat_acad = ReportCategory.objects.get(slug='academic-ops')
    reports_acad = [
    ...
    for key, title, desc, endpoint, icon in reports_acad:
        ReportDefinition.objects.get_or_create(
            ...
            defaults={
                ...
                'supports_pdf': True,
                'supports_print': True,
                'required_roles': ['super_admin', 'admin', 'principal', 'vice_principal', 'campus_admin', 'academic', 'teacher'],
            }
        )
