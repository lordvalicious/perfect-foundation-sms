...
| **Status** | **PARTIAL** — Root and /reports/ added, /members/ and /settings/ remain 404 |
...
| **Status** | **OPEN** — ReportsRootView added but /api/reports/ base may need routing fix |
