...
|------|---------|-----------------|
| ACCOUNTANT | DEG-EMP-00031 | No password available — FIXED provisioning |
| LIBRARIAN | SA-EMP-00011 | No password available — FIXED provisioning |
...
| GUARD | SA-EMP-00031 | No password available — FIXED provisioning |
| ADMIN_OFFICER | SA-EMP-00041 | No password available — FIXED provisioning |
| NURSE | SA-EMP-0002 | Requires school_code |
| TEACHER2 | SA-EMP-0003 | No password available — FIXED provisioning |
| TEACHER3 | SA-EMP-0004 | No password available — FIXED provisioning |
| STUDENT2 | SA-ST-0002 | No password available — FIXED provisioning |
| STUDENT3 | SA-ST-0003 | No password available — FIXED provisioning |
