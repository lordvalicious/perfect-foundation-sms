...
| **Status** | **OPEN** - Requires production database access |
...
| **Safe Remediation** | Set must_change_password=False for test accounts; or implement password change flow |
| **Status** | **OPEN** - Requires production database access |
...
| **Status** | ✅ **FIXED** - Frontend configuration updated |
...
| **Status** | **OPEN** - Requires backend permission fix |
...
|------|---------|-----------------|
| ACCOUNTANT | DEG-EMP-00031 | No session (must_change_password) |
...
| GUARD | SA-EMP-00031 | No session (must_change_password) |
| ADMIN_OFFICER | SA-EMP-00041 | No session (must_change_password) |
| NURSE | SA-EMP-0002 | Requires school_code |
| TEACHER2 | SA-EMP-0003 | No session (must_change_password) |
| TEACHER3 | SA-EMP-0004 | No session (must_change_password) |
| STUDENT2 | SA-ST-0002 | No session (must_change_password) |
| STUDENT3 | SA-ST-0003 | No session (must_change_password) |
...
| Category | Count |
|----------|-------|
| Critical Defects (Blocking) | 3 (D-001, D-002, D-003) |
| Medium Defects | 3 (D-005, D-006, D-007) |
| Design/Architecture | 2 (D-008, D-009) |
| Accounts Unavailable | 13 |
| Roles Not Testable | 11 |

**Most Critical**: D-001, D-002, D-003 — These three defects completely block Librarian and all specialized role testing.